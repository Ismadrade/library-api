...
public class BookControllerTest {
    ...
    public void createBookTest() throws Exception{
        ...
        BookDTO dto = BookDTO.builder().author("Ismael").title("As Aventuras").isbn("001").build();
        Book savedBook = Book.builder().id(101).author("Ismael").title("As Aventuras").isbn("001").build();
